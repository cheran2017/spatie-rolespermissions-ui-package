...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        if (auth()->user()->can('Users')) {
            return view('rolespermissions::admin.views.users.users')->with('data',$data);    
        } else {
            abort(403);
        }
    ...
    public function create()
    {
        ...
        $data    =  [ 'roles' => $roles ];
        return view('rolespermissions::admin.views.users.user-create')->with('data',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($user->save()) {
            if (!empty($request->role_id)) {
                ...
                $user->assignRole((string)$role->name);
    ...
    public function show($id)
    {
        ...
        return view('rolespermissions::admin.views.users.user-edit')->with('data',$data);
    }
