...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        if (auth()->user()->can('Roles')) {
            return view('rolespermissions::admin.views.roles.role')->with('data',$data);    
        } else {
            abort(403);
        }
    ...
    public function create()
    {
        ...
        return view('rolespermissions::admin.views.roles.role-create')->with('data',$data);
    }
    ...
    public function show($id)
    {
        ...
        return view('rolespermissions::admin.views.roles.role-edit')->with('data',$data);
    }
