...
class PermissionGroupController extends Controller
{
    ...
    {
        $permissions = PermissionGroup::orderBy('id','desc')->paginate(5);
        $data        = [ 'permissions_groups' => $permissions ];

        if (auth()->user()->can('Permission Groups')) {
            return view('rolespermissions::admin.views.permission-groups.permission-group')->with('data',$data);
        } else {
            abort(403);
        }
    ...
    public function create()
    {
        ...
        return view('rolespermissions::admin.views.permission-groups.permission-group-create')->with('data',$data);
    }
    ...
    public function show(PermissionGroup $permissionGroup,$id)
    {
        ...
        return view('rolespermissions::admin.views.permission-groups.permission-group-edit')->with('data',$data);
    }
