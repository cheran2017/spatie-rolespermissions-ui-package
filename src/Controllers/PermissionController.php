...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        if (auth()->user()->can('Permissions')) {
            return view('rolespermissions::admin.views.permissions.permission')->with('data',$data);
        } else {
            abort(403);
        }
    ...
    {
        return view('rolespermissions::admin.views.permissions.permission-create');
    }
    ...
    public function show($id)
    {
        ...
        return view('rolespermissions::admin.views.permissions.permission-edit')->with('data',$data);
